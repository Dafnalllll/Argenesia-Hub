...
<div>
    ...
    <div class="w-full flex justify-center md:justify-start mt-20 md:mt-12 mb-10 px-2 md:px-0">
        <div class="flex md:flex-row items-center gap-4">
            ...
            <span class="text-4xl font-extrabold bg-white bg-clip-text text-transparent drop-shadow-lg tracking-wide text-center md:text-left">
                Manajemen Cuti
            </span>
    </div>
</div>
    <!-- Card Ringkasan -->
    <div class="w-full max-w-xs mx-auto grid grid-cols-1 gap-4 mb-8 mt-20 md:max-w-none md:grid-cols-3 md:gap-6">
        <!-- Card Sisa Cuti -->
        <div class="bg-white/30 backdrop-blur-md rounded-xl shadow p-4 flex flex-col items-center hover:scale-105 transition-all cursor-pointer">
    ...
    <div class="w-full max-w-xs mx-auto bg-white/40 backdrop-blur-md rounded-2xl shadow-lg p-4 mb-8 md:max-w-none md:p-8">
        ...
        @else
            <div class="text-gray-700">Belum ada pengajuan cuti.</div>
        @endif
        <div class="mt-4">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm border border-gray-300 rounded-lg overflow-hidden mt-2">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="py-2 px-3 text-center text-gray-700">Belum ada riwayat pengajuan cuti.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
