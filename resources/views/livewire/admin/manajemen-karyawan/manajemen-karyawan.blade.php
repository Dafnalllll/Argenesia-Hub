            ...
            <table class="min-w-275 w-full text-sm text-gray-700 rounded-2xl shadow-lg border-separate border-spacing-0">
                ...
                <tbody>
                    ...
                    <template x-if="paginatedKaryawans.length === 0">
                        <tr>
                            <td colspan="7" class="py-6 text-center text-gray-800">Tidak ada karyawan ditemukan.</td>
                        </tr>
                    </template>
                </tbody>
            </table>
        ...
        <div class="flex justify-end mt-6">
            <div x-data="{ open: false }" class="relative">
                <button
                    ...
                    class="px-5 py-2 rounded-lg bg-linear-to-r from-[#F53003] to-[#0074D9] text-white font-semibold shadow hover:bg-blue-700 transition-all flex items-center gap-2 cursor-pointer hover:scale-105"
                >
