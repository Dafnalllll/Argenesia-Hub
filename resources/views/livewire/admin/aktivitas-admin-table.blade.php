                ...
                @forelse ($aktivitasAdmin as $aktivitas)
                    <tr class="hover:bg-gray-100 transition text-center animate-fade-in-up">
                        ...
                        <td class="py-2 px-4">
                            ...
                            <span class="text-xs text-gray-700">({{ \Carbon\Carbon::parse($aktivitas->tanggal)->diffForHumans() }})</span>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="3" class="py-2 px-4 text-center text-gray-700">Tidak ada aktivitas admin.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
