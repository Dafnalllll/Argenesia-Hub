{{-- filepath: resources/views/livewire/admin/manajemen-cuti/rekap-cuti.blade.php --}}
@section('title', 'Rekap Cuti || Argenesia Hub')

<div>
    {{-- Mobile View --}}
    <div class="block md:hidden p-6 mt-8">
        @include('livewire.admin.manajemen-cuti.rekap-cuti-mobile')
    </div>
    ...
    >
        <h1 class="hidden md:flex text-3xl font-bold mb-8 text-white tracking-wide items-center gap-4">
            <img src="{{ asset('img/sidebar/rekap.webp') }}" alt="Cuti" class="w-10 h-10" />
            Rekap Cuti
        </h1>
        <div class="bg-white/40 backdrop-blur-md border border-white/30 rounded-2xl shadow-2xl p-8 hidden md:block">
            <div class="flex flex-col gap-2 w-full md:w-auto mb-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div class="relative w-full md:w-72 group">
                        <input
                            ...
                            x-model="search"
                            @input="currentPage = 1"
                            placeholder="Cari nama karyawan atau tipe cuti..."
                ...
                <div class="flex gap-2 mt-2">
                    ...
                    <div x-data="{ open: false }" class="relative group w-full md:w-44">
                        ...
                        >
                            <span>
                                <template x-if="!filterBulan"><span class="text-gray-700 font-semibold whitespace-nowrap">Semua Bulan</span></template>
                    ...
                    <div x-data="{ open: false }" class="relative group w-full md:w-46">
                        ...
                        >
                            <span>
                                <template x-if="!filterTahun"><span class="text-gray-700 font-semibold whitespace-nowrap">Semua Tahun</span></template>
